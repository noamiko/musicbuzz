    ...
    if (songList !== null && songList !== "") {
        ...
        for (var i = 0; i < songList.length; i++) {
            content += "<div class='ui-grid-b'>"
                    ...
                    + "<div class='ui-block-c'><a href='#' class='dislike_btn ui- ui-btn-inline ui-btn ui-corner-all ui-btn-icon-left ui-icon-delete like_btn' onclick='dislike(" + songList[i]._id + ");'></a></div>"
                    + "</div>";
