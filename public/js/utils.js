...
//                    + "<div class='ui-block-c'><a href='#' class='dislike_btn ui-shadow ui-btn-inline ui-btn ui-corner-all ui-btn-icon-right ui-icon-delete' onclick='dislike(" + songList[i]._id + ");'></a></div>"
//                    + "</div>"
            content += +"<div data-inline='true'>"
